  ...
  window.initCurve = function (canvas, ui) {
    ...
    const tour = [
      { title: "Meet a student.",
        ...
        demand: 0.05, support: 0.10, cam: { theta: 0.10, phi: 1.30, radius: 8.2 }, hold: 3600 },
      { title: "A bit of pressure helps.",
        ...
        demand: 0.24, support: 0.10, cam: { theta: 0.22, phi: 1.20, radius: 7.4 }, hold: 4000 },
      { title: "This is their peak.",
        text: "Top of the hill. Carrying a real load and handling it. Every student has a point like this.",
        demand: 0.31, support: 0.10, cam: { theta: 0.34, phi: 1.06, radius: 6.6 }, hold: 4000 },
      { title: "Then it tips.",
        ...
        demand: 0.80, support: 0.10, cam: { theta: 0.05, phi: 1.12, radius: 7.2 }, hold: 5000 },
      { title: "Now add support.",
        text: "Same student. Same pile of work. The whole hill lifts and stretches right \u2014 and they stand back up.",
        demand: 0.80, support: 0.92, cam: { theta: -0.30, phi: 1.14, radius: 8.4 }, hold: 5600 },
      { title: "That's the whole idea.",
        ...
        demand: 0.62, support: 0.92, cam: { theta: 0.30, phi: 1.22, radius: 8.4 }, hold: 4600 }
    ];
