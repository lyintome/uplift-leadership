...
(function () {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    buildSources();
    buildNav();
    // Both INFO and UPLIFT are declared with top-level `const`, which does not
    // create a window property. Test the binding, not window.
    if (typeof INFO !== "undefined") INFO.mount();
    if (window.mountMainPoll) window.mountMainPoll();
