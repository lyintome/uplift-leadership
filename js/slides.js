...
(function () {
  ...
  window.mountMainPoll = function () {
    ...
    // data.js declares `const UPLIFT`, and a top-level const is NOT a property
    // of window — so test the binding itself, not window.UPLIFT.
    if (typeof UPLIFT === "undefined" || !UPLIFT.poll) return;
